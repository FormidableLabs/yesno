...
You can save only filtered requests by using yesno.matching to get the filtered records. Then pass them in the records parameter of the options to save.
